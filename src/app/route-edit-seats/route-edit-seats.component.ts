...
@Component({
  selector: 'app-route-edit-seats',
  templateUrl: './route-edit-seats.component.html',
  styleUrls: ['./route-edit-seats.component.css']
})
export class RouteEditSeatsComponent implements OnInit {
